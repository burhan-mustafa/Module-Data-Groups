...
test("given an array with no duplicates, it returns the original array", () => {
  const arr = ["a", "b", "c"];
  expect(dedupe(arr)).toEqual(["a", "b", "c"]);
});
...
test("given an array of strings, it returns a new array with duplicates removed", () => {
  const arr = ["a", "a", "a", "b", "b", "c"];
  expect(dedupe(arr)).toEqual(["a", "b", "c"]);
});

test("given an array of numbers, it returns a new array with duplicates removed", () => {
  const arr = [5, 1, 1, 2, 3, 2, 5, 8];
  expect(dedupe(arr)).toEqual([5, 1, 2, 3, 8]);
});
